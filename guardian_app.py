...
# This code snippet is implementing a crisis assistant application using Streamlit, a Python library
# for creating web applications. Here's a breakdown of what the code is doing:
# import streamlit as st
# import asyncio
# from guardian_logic import handle_message
...
#     if st.session_state.active_agent:
#         result = asyncio.run(
#             handle_message(user_input, forced_agent=st.session_state.active_agent)
#         )
#     else:
#         result = asyncio.run(handle_message(user_input))
...
# if "crisis_resolved" not in st.session_state:
#     st.session_state.crisis_resolved = False
...
#         st.session_state.crisis_resolved = True

#         response_text = "✅ Glad you are safe now. Crisis session closed."
...
#         st.warning("🔁 Switching back to GuardianAI general support.")
